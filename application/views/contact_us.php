...
<head>
    ...
    <link type=text/css media=all href=assets/wp-content/cache/autoptimize/css/contact.css rel=stylesheet>
    ...
    <title>Seconds Digital Solutions | Contact Us</title>
                                ...
                                <div class=entry-content>
                                    <div id=dslc-main>
                                        <div class="dslc-modules-section  dslc-full  dslc-no-columns-spacing " style="padding-bottom:0px;padding-top:0px;background-color:transparent;border-right-style: hidden; border-left-style: hidden; " data-section-id=1508f48843b>
                                            <div class="dslc-modules-section-wrapper dslc-clearfix">
                                                <div class="dslc-modules-area dslc-col dslc-12-col dslc-last-col" data-size=12>
                                                    <div id=dslc-module-af63c3ec9d6 class="dslc-module-front dslc-module-DSLC_Html dslc-in-viewport-check dslc-in-viewport-anim-none  dslc-col dslc-12-col dslc-last-col  dslc-module-handle-like-regular " data-module-id=af63c3ec9d6 data-module=DSLC_Html data-dslc-module-size=12 data-dslc-anim=none data-dslc-anim-delay data-dslc-anim-duration=650 data-dslc-anim-easing=ease data-dslc-preset=none>
                                        ...
                                        <div class="dslc-modules-section " style="padding-bottom:0px;padding-top:0px;border-right-style: hidden; border-left-style: hidden; " data-section-id=c4f95125ecd>
                                            <div class="dslc-modules-section-wrapper dslc-clearfix">
                                                                ...
                                                                <div class="dslc-info-box-main-wrap dslc-clearfix">
                                                                    ...
                                                                    <div class=dslc-info-box-main>
                                                                        <div class=dslc-info-box-title>
                                                                            <h4>+91-9901288733</h4></div>
                                                                        <div class=dslc-info-box-content></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div id=dslc-module-1353 class="dslc-module-front dslc-module-DSLC_Button dslc-in-viewport-check dslc-in-viewport-anim-none  dslc-col dslc-12-col dslc-last-col  dslc-module-handle-like-regular " data-module-id=1353 data-module=DSLC_Button data-dslc-module-size=12 data-dslc-anim=none data-dslc-anim-delay=0 data-dslc-anim-duration=650 data-dslc-anim-easing=ease data-dslc-preset=none>
                                                        <div class=dslc-button>
                                                            <a href=# target=_self onClick class>
                                                                ...
                                                                <span>info@secondsdigital.com</span>
                                                            </a>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="dslc-info-box dslc-info-box-icon-pos-aside dslc-info-box-image-pos-above">
                                                            <div class=dslc-info-box-wrapper>
                                                                <div class="dslc-info-box-main-wrap dslc-clearfix">
                                                                    <div class=dslc-info-box-image>
                                                                        <div class=dslc-info-box-image-inner>
                                                                            <span class="dslc-icon dslc-icon-ext-location3"></span></div>
                                                                    </div>
                                                                    <div class=dslc-info-box-main>
                                                                        <div class=dslc-info-box-title>
                                                                            <h4>No. 11/2, First Floor, Sigma Trident Building, Hayes Road, Off, Richmond Rd, Bengaluru, Karnataka 560025</h4></div>
                                                                        <div class=dslc-info-box-content></div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="dslc-modules-area dslc-col dslc-8-col dslc-last-col" data-size=8>
                                            ...
                                            <ul class=dslc-social>
                                                ...
                                                <li>
                                                    <a class=dslc-social-icon target=_blank href="https://www.youtube.com/channel/UCEHhYqVJ-Y5mXWKJFNx2Udg?view_as=subscriber">
                                                        <span class="dslc-icon dslc-icon-youtube-play"></span></a>
                                                </li>
                                                <li>
