...
>>>>>>> 5b978005b0cef7c6faae4a70e8c757d7d040753a
                                       ...
                                       <div class="col-md-6">
                                          <div class="card text-white bg-primary flex-md-row mb-4 shadow-sm h-md-250">
                                             <div class="card-body d-flex flex-column align-items-start">
                                                ...
                                                <div class="mb-1 text-white-50 small">April 2020</div>
                                                <p class="card-text mb-auto">This is a wider card with supporting text below as a natural lead-in to additional content.</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="card flex-md-row bg-dark mb-4 shadow-sm h-md-250">
                                               <div class="card-body d-flex flex-column align-items-start">
                                                  <strong class="d-inline-block mb-2 card-title">World</strong>
                                                  <h6 class="mb-0">
                                                     <a class="text-dark" href="#">40 Percent of People Can’t Afford Basics</a>
                                                  </h6>
                                                  <div class="mb-1 text-muted small">April 2020</div>
                                                  <p class="card-text mb-auto">This is a wider card with supporting text below as a natural lead-in to additional content.</p>
                                                  <a class="btn btn-primary btn-sm" role="button" href="#">Continue reading</a>
                                               </div>
                                               <img class="card-img-right flex-auto d-none d-lg-block" alt="Thumbnail [200x250]" src="assets/wp-content/uploads/services-web-development-380x380.png" style="width: 237px;height: 250px;">
                                            </div>
                                         </div>
                                         <div class="col-md-6">
                                            <div class="card mb-4 text-white bg-dark">
                                               <img class="card-img-top" src="assets/wp-content/uploads/Fotolia_56716934_M.jpg" alt="Card image cap">
                                               <div class="card-body">
                                    ...
                                    <div id=dslc-module-e5f25a6682d class="dslc-module-front dslc-module-DSLC_Image dslc-in-viewport-check dslc-in-viewport-anim-none  dslc-col dslc-12-col dslc-last-col  dslc-module-handle-like-regular " data-module-id=e5f25a6682d data-module=DSLC_Image data-dslc-module-size=12 data-dslc-anim=none data-dslc-anim-delay data-dslc-anim-duration=650 data-dslc-anim-easing=ease data-dslc-preset=none>
                                        <div class=dslc-image-container>
                                            <div class=dslc-image>
                                                <img src='assets/wp-content/uploads/PartnerBadge-RGB.png' alt ></div>
                                        </div>
                                    </div>
                                </div>
